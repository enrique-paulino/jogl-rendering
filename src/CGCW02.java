...
//			T.lookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default
			...
			// Sets the transformations of the second object
			T.scale(0.3f,0.3f,0.3f);
			T.translate(0, -0.8f, 0);
			gl.glUniformMatrix4fv( ModelView, 1, true, T.getTransformv(), 0 );

			// Binds the second object with its ID which is equal to +1 of the previous object
			idPoint=1;
			idBuffer=1;
			idElement=1;
			bindObject(gl);
		...
		public void init(GLAutoDrawable drawable) {
			...
			// Creates lighting information based on the material and lighting settings
			...
			//Create the second object (a cone) here, and sets its ID equal to +1 of the previous object
			SObject cone = new SCone(4,8, 40);
			idPoint=1;
			idBuffer=1;
			idElement=1;
			...
			// Calculates lighting information based on material and lighting settings
